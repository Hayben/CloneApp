...
- (void) calculateExpandedCoordinates{
    ...
    float section = _choices.count + 1;
    ...
    for (int i=0; i < _choices.count; i++) {
      ...
      float sectionDistance = screenWidth/section;
      Coordinate *coordinate = [[Coordinate alloc] init];
      int tag = subviewTagConstant*(i+1);
      coordinate.x = [NSNumber numberWithFloat:(i + 1) * sectionDistance];
      coordinate.y = [NSNumber numberWithFloat:screenHeight/2];
